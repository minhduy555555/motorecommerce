                        ...
                        <div className="flex items-center justify-between text-blue-gray-900">
                            ...
                            <div className="relative flex w-full gap-2 md:w-max">
                                <div className="relative h-10 w-full min-w-[30rem]">
                                    <input
                                        type="search"
                                        className="peer h-full w-full rounded-[7px] border bg-transparent px-3 py-3.5 pr-20 font-sans text-sm font-normal !text-white transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-white focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                        placeholder=" "
                                    />
                                ...
                                <button
                                    className="!absolute right-1 top-1 select-none rounded bg-gray py-2 px-4 text-center align-middle font-sans text-xs font-bold bg-slate-400 uppercase text-blue-gray-900 shadow-md shadow-blue-gray-500/10 transition-all hover:shadow-lg hover:shadow-blue-gray-500/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                    type="button"
                                >
                                    Tìm kiếm
                                </button>
