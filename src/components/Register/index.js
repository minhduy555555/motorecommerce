...
const RegisterModal = ({ setShowModal, setShowLoginModal }) => {
    ...
    return (
        <div id="modal-content" onClick={handleClose}>
            <div style={{zIndex:'99'}} className="fixed inset-0 bg-[#2B92E4] bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
